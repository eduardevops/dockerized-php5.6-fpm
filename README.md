...
### Status
<img alt="Image Size" src="https://img.shields.io/docker/image-size/eduardevops/lemp-php5.6-fpm" style="max-width:100%;"> <img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/eduardevops/lemp-php5.6-fpm" style="max-width:100%;"> <img alt="Build Status" src="https://img.shields.io/docker/cloud/build/eduardevops/lemp-php5.6-fpm" style="max-width:100%;"> <img alt="Licenses" src="https://img.shields.io/badge/License-GPLv3-blue.svg" style="max-width:100%;">
...
For PHP5.6 with Apache2 use [Dockerized PHP5.6 with Apache2](https://github.com/eduardevops/dockerized-lamp-php5.6)
...
```less
sudo git clone https://github.com/eduardevops/dockerized-lemp-php5.6-fpm.git
```
